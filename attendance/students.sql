CREATE DATABASE angularcode_students;


USE angularcode_students;
...
INSERT INTO `students` (`id`, `name`, `eid`, `phone`, `fn`, `mn`, `cn`, `cn`, `stock`, `batch`) VALUES
